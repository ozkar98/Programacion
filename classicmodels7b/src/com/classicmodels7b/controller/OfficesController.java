...
public class OfficesController {
    ...
    public String createOffice(String officeCode, String city, String phone, String addressLine1, String addressLine2, String state, String country, String postalCode, String territorry){
    
        OfficesModel newOffice;
        
        newOffice = new OfficesModel(officeCode, city, phone, addressLine1, addressLine2, state, country, postalCode, territorry);
   ...
   return serverAnswer;
    ...
    public String updateOffice(String officeCode, String city, String phone, String addressLine1, String addressLine2, String state, String country, String postalCode, String territorry){
        OfficesModel newOffice;
   ...
   return serverAnswer;
    ...
    public String deleteOffice(String offficeCode){
           String serverAnswer= officesDaoImple.deleteOffice(offficeCode);
           return serverAnswer;
}
}
